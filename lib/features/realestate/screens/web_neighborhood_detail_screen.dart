...
class WebNeighborhoodDetailContent extends StatefulWidget {
  ...
  @override
  State<WebNeighborhoodDetailContent> createState() =>
      _WebNeighborhoodDetailContentState();
}

class _WebNeighborhoodDetailContentState
    extends State<WebNeighborhoodDetailContent> {
  ...
  List<_NeighStat> get _stats => [
    _NeighStat(
      value: '12',
      label: _t('Properties for Sale', 'נכסים למכירה'),
    ...
    _NeighStat(
      value: '6',
      label: _t('Parks & Playgrounds', 'פארקים וגנים'),
      icon: IconsaxPlusBold.tree,
    ),
    _NeighStat(
      value: '7',
      label: _t('Schools & Kindergardens', 'בתי ספר וגנים'),
  ...
  List<_HighlightItem> get _highlights => [
    _HighlightItem(
      text: _t(
        'Close to main highways and public transport',
        'קרוב לכבישים ראשיים ותחבורה ציבורית',
      ),
    ),
    _HighlightItem(
      text: _t('Excellent schools and kindergartens', 'בתי ספר וגנים מצוינים'),
    ),
    _HighlightItem(
      text: _t(
        'Surrounded by parks and open spaces',
        'מוקף פארקים ושטחים פתוחים',
      ),
    ),
    _HighlightItem(
      text: _t(
        'Active neighborhood commercial center',
        'מרכז מסחרי שכונתי פעיל',
      ),
    ),
  ];
  ...
  List<_PropertyCard> get _saleListings => [
    ...
    _PropertyCard(
      ...
      area: '180 m²',
      rooms: _t('7 Rooms', '7 חדרים'),
      floor: _t('Floor 5', 'קומה 5'),
      isNew: false,
      viaBroker: true,
  ...
  List<_PropertyCard> get _rentListings => [
    ...
    _PropertyCard(
      ...
      tag: _t('FOR RENT', 'להשכרה'),
      address: _t(
        '12 Yitzhak Shamir Street, Modiin',
        'רח׳ יצחק שמיר 12, מודיעין',
      ),
      area: '122 m²',
      rooms: _t('4 Rooms', '4 חדרים'),
      floor: _t('Floor 2', 'קומה 2'),
    ...
    _PropertyCard(
      ...
      area: '155 m²',
      rooms: _t('5 Rooms', '5 חדרים'),
      floor: _t('Floor 1', 'קומה 1'),
      isNew: true,
      viaBroker: true,
      imageBg: const Color(0xFFC8D8E0),
    ),
  ...
  List<_BusinessData> get _businesses => [
    ...
    _BusinessData(
      ...
      rating: 4.9,
      reviews: 143,
      imageBg: const Color(0xFFE8E0D4),
    ),
  ];
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  _t('Neighborhood Highlights', 'דגשי השכונה'),
                  style: TextStyle(
                    fontFamily: AppFonts.nunito,
                    fontSize: 24,
                    fontWeight: FontWeight.w600,
  ...
  Widget _buildPropertyCarousel({
    ...
    required List<_PropertyCard> listings,
  }) {
              ...
              children: [
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return SizedBox(
                      width: 301,
                      child: _BusinessCardWidget(
                        data: _businesses[index],
                        isHebrew: _isHebrew,
                      ),
                    );
                  },
                    ...
                    children: [
                      if (d.viaBroker)
                        Container(
                          ...
                          child: Text(
                            widget.isHebrew ? 'דרך מתווך' : 'Via Broker',
                            style: TextStyle(
                              fontFamily: AppFonts.inter,
                              fontSize: 11,
                              fontWeight: FontWeight.w500,
