...
final _mockFlags = <Map<String, dynamic>>[
  {
    ...
    'key': 'AI_SEARCH',
    'label': 'חיפוש AI',
    'description': 'חיפוש חכם עם הבנת שפה טבעית',
    'is_enabled': true,
    'rollout_pct': 50,
  ...
  },
  {
    ...
    'key': 'REAL_ESTATE',
    'label': 'נדל"ן',
    'description': 'מודול דירות להשכרה ומכירה',
    'is_enabled': true,
    'rollout_pct': 100,
    'platforms': ['ios', 'android', 'web'],
    'config': {},
  ...
  },
  {
    ...
    'key': 'STEPS_TRACKER',
    'label': 'מעקב צעדים',
    'description': 'ספירת צעדים יומית עם נקודות',
    'is_enabled': true,
    'rollout_pct': 100,
    'platforms': ['ios', 'android'],
    'config': {'daily_goal': 10000},
    'updated_by': 'ניתאי לוי',
  ...
  },
  {
    ...
    'label': 'התראות Push',
    'description': 'שליחת Push Notifications',
    'is_enabled': true,
    'rollout_pct': 100,
    'platforms': ['ios', 'android'],
  ...
  },
  {
    ...
    'key': 'GAMES',
    'label': 'משחקים',
    'description': 'מודול משחקים עם נקודות',
    'is_enabled': true,
    'rollout_pct': 80,
    'platforms': ['ios', 'android'],
    'config': {'max_daily_points': 100},
    'updated_by': 'ניתאי לוי',
  ...
  },
  {
    ...
    'key': 'DEALS_V2',
    'label': 'מבצעים V2',
    'description': 'ממשק מבצעים חדש עם קופונים',
    'is_enabled': false,
    'rollout_pct': 0,
    'platforms': ['ios', 'android', 'web'],
    'config': {},
  ...
  },
  {
    ...
    'key': 'SOCIAL_LOGIN',
    'label': 'כניסה חברתית',
    'description': 'התחברות עם Google / Apple',
    'is_enabled': true,
    'rollout_pct': 100,
    'platforms': ['ios', 'android'],
    'config': {
  ...
  },
  {
    ...
    'key': 'CHAT',
    'label': 'צ\'אט',
    'description': 'צ\'אט ישיר עם בעלי עסקים',
    'is_enabled': false,
    'rollout_pct': 0,
    'platforms': ['ios', 'android'],
    'config': {},
  ...
  },
  {
    ...
    'key': 'AR_MAP',
    'label': 'מפת AR',
    'description': 'מציאות רבודה על המפה',
    'is_enabled': false,
    'rollout_pct': 0,
    'platforms': ['ios', 'android'],
    'config': {},
...
final _mockRemoteConfig = <Map<String, dynamic>>[
  {
    'id': 'rc_1',
    'key': 'HOME_HEADLINE',
    'value': 'מודיעין בשבילך — הכל במקום אחד',
    'description': 'כותרת ראשית במסך הבית',
    'updated_by': 'ניתאי לוי',
  ...
  {
    'id': 'rc_2',
    'key': 'EMPTY_STATE_SEARCH',
    'value': 'לא נמצאו תוצאות. נסו מילות חיפוש אחרות.',
    'description': 'הודעה כשאין תוצאות חיפוש',
    'updated_by': 'ניתאי לוי',
    'created_at': '2024-01-01T10:00:00Z',
  ...
  },
  {
    ...
    'key': 'ONBOARDING_CTA',
    'value': 'בואו נתחיל! 🚀',
    'description': 'כפתור CTA במסך ה-onboarding',
    'updated_by': 'ניתאי לוי',
    'created_at': '2024-01-01T10:00:00Z',
  ...
  },
  {
    ...
    'value': 'האפליקציה בתחזוקה. נחזור בקרוב!',
    'description': 'הודעת תחזוקה (מוצגת רק אם feature flag MAINTENANCE פעיל)',
    'updated_by': 'ניתאי לוי',
  ...
  },
  {
    ...
    'key': 'MIN_APP_VERSION',
    'value': '1.2.0',
    'description': 'גרסת אפליקציה מינימלית (מתחתיה = force update)',
    'updated_by': 'ניתאי לוי',
    'created_at': '2024-01-01T10:00:00Z',
    'updated_at': '2026-08-01T10:00:00Z',
  },
  {
    'id': 'rc_6',
    'key': 'CONTACT_EMAIL',
    'value': 'info@modiin4u.co.il',
    'description': 'אימייל ליצירת קשר',
    'updated_by': 'ניתאי לוי',
    'created_at': '2024-01-01T10:00:00Z',
  ...
  },
  {
    ...
    'key': 'ABOUT_TEXT',
    'value':
        'מודיעין בשבילך היא אפליקציה קהילתית עירונית שמחברת בין תושבי מודיעין-מכבים-רעות לעסקים, שירותים ואירועים בעיר.',
    'description': 'טקסט "אודות" בהגדרות',
    'updated_by': 'ניתאי לוי',
    'created_at': '2024-01-01T10:00:00Z',
  ...
  },
  {
    'id': 'rc_8',
    'key': 'TERMS_URL',
    'value': 'https://modiin4u.co.il/terms',
    'description': 'קישור לתנאי שימוש',
    'updated_by': 'ניתאי לוי',
    'created_at': '2024-01-01T10:00:00Z',
    'updated_at': '2024-01-01T10:00:00Z',
  },
