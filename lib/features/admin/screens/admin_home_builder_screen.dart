    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Row(children: [
          ...
          Text('בונה מסך הבית', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.navy)),
          const Spacer(),
          OutlinedButton.icon(
            onPressed: () => ref.read(adminHomeBuilderProvider.notifier).publishAll(),
            icon: const Icon(Icons.publish, size: 16),
            label: Text('פרסם הכל', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 13)),
          ...
          FilledButton.icon(
            ...
            label: Text('בלוק חדש', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 13)),
          ...
          data: (list) {
            if (list.isEmpty) {
              return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('אין בלוקים', style: TextStyle(fontFamily: AppFonts.rubik, color: AppColors.grayText)),
              ]));
            }
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    leading: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text('#${b['sort_order']}', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 10, color: AppColors.grayLight)),
                    ]),
                    title: Row(children: [
                      Icon(_blockIcon(blockType), size: 20, color: isActive ? AppColors.turquoise : AppColors.grayLight),
                      const SizedBox(width: 8),
                      Expanded(child: Text(b['title'] as String? ?? '', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.navy))),
                    ]),
                    subtitle: Padding(
                      ...
                      child: Row(children: [
                        Container(
                          ...
                          child: Text(blockType, style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 10, color: AppColors.navy)),
                        ),
                        const SizedBox(width: 8),
                        Text('v$version', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 10, color: AppColors.grayLight)),
                        const SizedBox(width: 8),
                        if (isPublished)
                          Row(mainAxisSize: MainAxisSize.min, children: [
                            Icon(Icons.check_circle, size: 12, color: AppColors.success),
                            const SizedBox(width: 3),
                            Text('מפורסם', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 10, color: AppColors.success)),
                          ])
                        else
                          Row(mainAxisSize: MainAxisSize.min, children: [
                            Icon(Icons.edit_note, size: 12, color: AppColors.gold),
                            const SizedBox(width: 3),
                            Text('טיוטה', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 10, color: AppColors.gold)),
                          ]),
                        if (isWide && b['audience'] != null) ...[
                          const SizedBox(width: 12),
                          Text('קהל: ${b['audience']}', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 10, color: AppColors.grayLight)),
                        ],
                      ]),
                    ),
          ...
          child: Form(
            ...
            child: Column(children: [
              Container(
                ...
                child: Row(children: [
                  Text(_isEditing ? 'עריכת בלוק' : 'בלוק חדש', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white)),
                  const Spacer(),
