    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Row(children: [
          ...
          const Spacer(),
          asyncData.whenData((list) => Text('${list.length} מבצעים', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 13, color: AppColors.grayText))).value ?? const SizedBox.shrink(),
          const SizedBox(width: 16),
          FilledButton.icon(
            onPressed: () => _showEditor(context, ref),
            icon: const Icon(Icons.add, size: 18),
            label: Text('מבצע חדש', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 13)),
          ...
          data: (list) {
            if (list.isEmpty) {
              return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('אין מבצעים', style: TextStyle(fontFamily: AppFonts.rubik, color: AppColors.grayText)),
              ]));
            }
            return Column(children: [
              Container(
                        ...
                        child: Row(children: [
                          Expanded(flex: 3, child: Row(children: [
                            ...
                            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text(o['title'] as String? ?? '', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.navy)),
                              if (o['description'] != null) Text(o['description'] as String, style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 11, color: AppColors.grayLight), maxLines: 1, overflow: TextOverflow.ellipsis),
                            ])),
                          ])),
                          Expanded(flex: 2, child: Text(o['business_name'] as String? ?? '', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 13, color: AppColors.grayText))),
                          if (isWide) Expanded(flex: 1, child: Text(_discountLabel(discountType), style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 12, color: AppColors.grayText))),
                          if (isWide) Expanded(flex: 1, child: Text(maxClaims != null ? '$claims / $maxClaims' : '$claims', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 13, fontFeatures: [const FontFeature.tabularFigures()]))),
                          if (isWide) Expanded(flex: 1, child: Text(o['code'] as String? ?? '—', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 12, color: AppColors.turquoise))),
                          ...
                          PopupMenuButton<String>(
                            ...
                            itemBuilder: (_) => [
                              ...
                              if (status == 'active') PopupMenuItem(value: 'expire', child: Text('סיים', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 13))),
          ...
          child: Form(
            ...
            child: Column(children: [
              Container(
                ...
                child: Row(children: [
                  Text(_isEditing ? 'עריכת מבצע' : 'מבצע חדש', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white)),
                  const Spacer(),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(children: [
                      ...
                      Expanded(child: SwitchListTile(
                        title: Text('מומלץ', style: TextStyle(fontFamily: AppFonts.rubik, fontSize: 14)),
                        value: _isFeatured,
