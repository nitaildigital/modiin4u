...
class AdminAdPlacementsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminAdPlacementsScreen> createState() =>
      _AdminAdPlacementsScreenState();
}

class _AdminAdPlacementsScreenState
    extends ConsumerState<AdminAdPlacementsScreen> {
  @override
  ...
  void _showEditor(
    ...
    showDialog(
      ...
      builder: (ctx) => _PlacementEditorDialog(placement: placement),
    );
  }
}
...
class _PlacementEditorDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_PlacementEditorDialog> createState() =>
      _PlacementEditorDialogState();
}

class _PlacementEditorDialogState
  ...
  void initState() {
    ...
    _maxBanners = TextEditingController(
