            ...
            data: (list) {
              ...
              return GridView.builder(
                ...
                itemBuilder: (_, i) => _TeamCard(
                  member: list[i],
                  onEdit: () => _showEditor(context, list[i]),
                  onToggle: () => ref
                      .read(adminTeamProvider.notifier)
                      .toggleActive(list[i]['id'] as String),
                ),
              );
            },
          ),
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setD) => Directionality(
          ...
          child: AlertDialog(
            title: Text(
              existing == null ? 'הוספת חבר צוות' : 'עריכת חבר צוות',
              style: TextStyle(
                fontFamily: AppFonts.rubik,
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (existing != null) {
                    ref
                        .read(adminTeamProvider.notifier)
                        .updateUser(existing['id'] as String, data);
                  } else {
                    ref.read(adminTeamProvider.notifier).createUser({
                      ...data,
                      'is_active': true,
                    });
                  }
...
class _TeamCard extends StatelessWidget {
  ...
  Color _roleColor(String r) => switch (r) {
    ...
    'admin' => AppColors.turquoise,
    'editor' => AppColors.midBlue,
