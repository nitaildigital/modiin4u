        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _FilterChip('הכל', _entityFilter.isEmpty, () {
                setState(() => _entityFilter = '');
                ref.read(adminTrashListProvider.notifier).setEntityFilter(null);
              }),
              _FilterChip('עסקים', _entityFilter == 'business', () {
                setState(() => _entityFilter = 'business');
                ref
                    .read(adminTrashListProvider.notifier)
                    .setEntityFilter('business');
              }),
              _FilterChip('כתבות', _entityFilter == 'article', () {
                setState(() => _entityFilter = 'article');
                ref
                    .read(adminTrashListProvider.notifier)
                    .setEntityFilter('article');
              }),
              _FilterChip('ביקורות', _entityFilter == 'review', () {
                setState(() => _entityFilter = 'review');
                ref
                    .read(adminTrashListProvider.notifier)
                    .setEntityFilter('review');
              }),
              _FilterChip('אירועים', _entityFilter == 'event', () {
                setState(() => _entityFilter = 'event');
                ref
                    .read(adminTrashListProvider.notifier)
                    .setEntityFilter('event');
              }),
              const Spacer(),
              asyncData
                      .whenData(
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                'פריטים נמחקים אוטומטית לאחר 30 יום',
                style: TextStyle(
                  fontFamily: AppFonts.rubik,
                  fontSize: 12,
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (t['entity_data'] != null &&
                                        t['entity_data'] is Map)
                                      Text(
                                        _entitySubtitle(
                                          entityType,
                                          t['entity_data'] as Map,
                                        ),
                                        style: TextStyle(
                                          fontFamily: AppFonts.rubik,
                                          fontSize: 11,
                              ...
                              Expanded(
                                flex: 1,
                                child: _EntityTypePill(entityType),
                              ),
                              if (isWide)
                                Expanded(
                                  flex: 2,
                                  child: Text(
                                    t['deleted_by_name'] as String? ?? '',
                                    style: TextStyle(
                                      fontFamily: AppFonts.rubik,
                                      fontSize: 13,
                                      color: AppColors.grayText,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () => ref
                                          .read(adminTrashListProvider.notifier)
                                          .permanentDelete(t['id'] as String),
                                    ),
                                  ],
                                ),
                              ),
